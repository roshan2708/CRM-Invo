              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.all(size.width > 600 ? 40 : size.width * 0.06),
                    ...
                    child: Column(
                      children: [
                        Hero(
                          tag: 'list_${lead.id}',
                          child: Container(
                            width: size.width > 600 ? 120 : size.width * 0.22,
                            height: size.width > 600 ? 120 : size.width * 0.22,
                            decoration: BoxDecoration(
                              color: avatarColor,
                              borderRadius: BorderRadius.circular(
                                size.width > 600 ? 32 : size.width * 0.06,
                              ),
                            ),
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                ...
                                fontSize: size.width > 600 ? 48 : size.width * 0.08,
                                fontWeight: FontWeight.w800,
                              ),
                            ),
                          ),
                        ),
                        SizedBox(height: size.width > 600 ? 24 : size.width * 0.04),
                            ...
                            return Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                    a.type.icon,
                                    style: TextStyle(fontSize: size.width > 600 ? 24 : size.width * 0.05),
                                  ),
                                  const SizedBox(width: 12),
                                  Expanded(
                                    child: Column(
